...
#     update.message.reply_text("Welcome! Type /songs [artist name] to get the first 3 songs of an artist.")

# # Command to fetch and display songs for an artist
# def get_artist_songs(update, context):
#     artist_name = ' '.join(context.args)
    
#     if not artist_name:
#         update.message.reply_text("Please provide an artist name. Example: /songs Kendrick Lamar")
#         return
    
#     songs = get_songs(artist_name)
    
#     if not songs:
#         update.message.reply_text(f"Sorry, no songs found for {artist_name}")
#         return
...
#     update.message.reply_text(f"Here are the top 3 songs by {artist_name}:", reply_markup=reply_markup)
...
#     dispatcher.add_handler(CommandHandler("songs", get_artist_songs))
